#!/bin/bash
#SBATCH -A csb185
#SBATCH --job-name="only_mean_thresholding_training_continue"
#SBATCH --output="./output/only_mean/only_mean_90000_100000/only_mean_thresholding_training_continue-%j.out"
#SBATCH --error="./output/only_mean/only_mean_90000_100000/only_mean_thresholding_training_continue-%j.err"
...
# TODO train the rest of the 10000 steps --- 40000 steps for accum = 4  --- check
model_path=/expanse/lustre/projects/csb185/thess/splade/splade_training_ht/output/only_mean/90000/0_MLMTransformer

# TODO train the rest of the 45000 steps --- 180000 steps for accum = 4
# model_path=/expanse/lustre/projects/csb185/thess/splade/splade_training_ht/output/plus_mean/55000/0_MLMTransformer
...
/bin/bash -c "python -m train_splade --model_name $model_path --train_batch_size 32 --accum_iter 4 --epochs 40000 --warmup_steps 6000 --loss_type marginmse --continues --num_negs_per_system 20 --training_queries $train_queries --thresholding mean"