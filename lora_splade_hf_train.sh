#!/bin/bash
#SBATCH --job-name="qrslora_llama_v2_distil_mse_contrastive_msl256_bs4_lr1e4_r4_a8_nneg3"
#SBATCH --output="./slurm_logs/llama_experiments/qrslora_llama_v2_distil_mse_contrastive_msl256_bs4_lr1e4_r4_a8_nneg3.%j.%N.out"
...
python -m splade.hf_train --config-name=config_hf_llama_distil.yaml